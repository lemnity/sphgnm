...
.sph {
  ...
  */
  ...
  /*
    ...
    В гайдбуке его нет, поэтому область применения узкая: ТОЛЬКО прорастающий
    знак в фоне первого экрана. Ещё где-то — и это уже не акцент, а пятая
    краска в четырёхцветной палитре.

    Живёт исключительно на ТЁМНОМ, как лайм: по Ink это 8.4:1, по Cream — 1.9:1,
    то есть на светлых секциях его быть не должно ни в каком виде.
